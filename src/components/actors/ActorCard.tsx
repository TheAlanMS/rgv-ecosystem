    ...
    >
      <div className="flex items-start gap-3 mb-1">
        {thumbnailIsPlaceholder ? (
          <div
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[8px] border border-border-default bg-surface2 text-[10px] font-semibold text-text-muted"
            aria-hidden="true"
          >
          ...
          <img
            ...
            alt=""
            className="h-10 w-10 shrink-0 rounded-[8px] border border-border-default object-cover"
          />
        )}
