...
export default defineSchema({
  actors: defineTable({
    ...
    pillarAssignments: v.optional(v.array(v.string())),
    websiteUrl: v.optional(v.string()),
    applyUrl: v.optional(v.string()),
    thumbnailUrl: v.optional(v.string()),
    internalNotes: v.optional(v.string()),
    qaStatus: v.optional(v.string()),
    publicVisibility: v.optional(v.string()),
    ...
    ecosystemRole: v.optional(v.string()),
    servicesOffered: v.optional(v.array(v.string())),
    audienceServed: v.optional(v.array(v.string())),
    eligibilityRequirements: v.optional(v.string()),
    programsOffered: v.optional(v.array(v.string())),
    eventsHosted: v.optional(v.array(v.string())),
    fundingAvailable: v.optional(v.string()),
    partnershipOpportunities: v.optional(v.string()),
    dataConfidenceScore: v.optional(v.number()),
